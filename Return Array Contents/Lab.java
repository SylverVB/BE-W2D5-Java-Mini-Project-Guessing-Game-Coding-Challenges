...
public class Lab {
    ...
    /**
     * Option 1: Using simple for loop and appending elements with space.
     */
    ...
    /**
     * Option 2: Using a for loop and adding spaces manually, excluding the last element.
     */
    // public String arrayToString(int[] nums){
    //     String str = "";
    //     for (int i = 0; i < nums.length; i++) {
    ...
    /**
     * Option 3: Using Arrays.toString and formatting the string (because we import java.util.Arrays).
     */
    public String arrayToString(int[] nums) {
        // Using Arrays.toString to convert the array into a string with square brackets and commas
        String arrayString = Arrays.toString(nums);
        
        // Removing the square brackets and commas, replacing them with spaces
        arrayString = arrayString.replace("[", "").replace("]", "").replace(",", "").trim();
